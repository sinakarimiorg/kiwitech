...
export default function ProductBox(props) {
    ...
    return (
        <>
            ...
            <Link href={`/product-info/${props.shortName}`}>
                    ...
                    <div>
                        ...
                        </div>
                        {
                            ...
                            <div className='flex justify-end items-center w-full'>
                                <span className='relative inline-flex ml-2 pl-5 xs:pl-7 pr-2 xs:font-medium text-xs xs:text-sm text-gray-500 overflow-hidden'>{props.exPrice.toLocaleString()}</span>
                            </div>
                        }
                    </div>
                </div>
