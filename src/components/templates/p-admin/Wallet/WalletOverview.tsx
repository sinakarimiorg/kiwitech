            ...
            <div className='flex flex-col items-center'>
                ...
                <div className='relative w-44 h-44 sm:w-48 sm:h-48'>
                    ...
                    <div className='absolute inset-0 flex flex-col items-center justify-center'>
                        <span className='font-IranYekanBold text-lg sm:text-xl text-zinc-800'>{totalBalance.toLocaleString()}</span>
                        <span className='text-xs text-zinc-400 mt-1'>موجودی خالص کیف پول‌ها (تومان)</span>
                    </div>
                </div>
